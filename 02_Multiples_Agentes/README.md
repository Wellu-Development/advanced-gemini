...
1.  Crear una carpeta (ej. `agents/`) para almacenar las definiciones de todos tus agentes.
...
2.  **Define al "Crítico Desalmado":**
    ...
    write_file --file_path "agents/critico.md" --content "
...
3.  **Define al "Documentador Amable":**
    ...
    write_file --file_path "agents/documentador.md" --content "
...
5.  **Activa y Usa al "Crítico Desalmado":**
    ...
    ```bash
    cp agents/critico.md ./GEMINI.md
    ```
...
6.  **Activa y Usa al "Documentador Amable":**
    ...
    ```bash
    cp agents/documentador.md ./GEMINI.md
    ```
